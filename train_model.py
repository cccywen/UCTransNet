...
#=================================================================================
##################################################################################
def main_loop(num_classes = 6, batch_size=config.batch_size, model_type='', tensorboard=True):
    ...
    if model_type == 'UCTransNet':
        ...
        logger.info('transformer layers num: {}'.format(config_vit.transformer.num_layers))
        logger.info('transformer expand ratio: {}'.format(config_vit.expand_ratio))
        model = UCTransNet(config_vit, n_channels=config.n_channels, n_classes=num_classes)
        pretrained_UNet_model_path = "/home/caoyiwen/pretrained weights/unet.pth"
