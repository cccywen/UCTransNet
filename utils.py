...
class WeightedBCE(nn.Module):
    ...
    def forward(self, logit_pixel, truth_pixel):
        # print("=====logit_pixel=======", logit_pixel.shape)
        # print("=====truth_pixel=======", truth_pixel.shape)
...
class WeightedDiceBCE(nn.Module):
    def __init__(self,dice_weight=1,BCE_weight=1):
        ...
        self.dice_loss = DiceLoss(n_classes=6)
...
def iou_on_batch(masks, pred):
    ...
    mIoU = np.nanmean(Intersection_over_Union()[:-1])
